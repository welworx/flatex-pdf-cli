...
1. **Extract text** from 4 real PDFs in `sensitive_test_docs/`:
   - `20250916_KaufFondsZertifikate_55000000999_100000001.pdf` (TRADE)
   - `20260130_KaufFondsZertifikate_55000000999_100000004.pdf` (TRADE)
   - `20251002_Fondsertragsausschuettung_55000000999_100000002.pdf` (DIVIDEND)
   - `20251003_Fondsertragsausschuettung_55000000999_100000003.pdf` (DIVIDEND)
