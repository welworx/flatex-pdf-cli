...
func TestTextExtractionFromRealPDF(t *testing.T) {
	...
	pdfPath := "../../sensitive_test_docs/20250916_KaufFondsZertifikate_55000000999_100000001.pdf"
...
func main() {
	pdfFiles := []string{
		"sensitive_test_docs/20250916_KaufFondsZertifikate_55000000999_100000001.pdf",
		"sensitive_test_docs/20260130_KaufFondsZertifikate_55000000999_100000004.pdf",
		"sensitive_test_docs/20251002_Fondsertragsausschuettung_55000000999_100000002.pdf",
		"sensitive_test_docs/20251003_Fondsertragsausschuettung_55000000999_100000003.pdf",
	}
...
From the extracted text of `20250916_KaufFondsZertifikate_55000000999_100000001.pdf`:
1. Copy the full extracted text
2. Replace all occurrences of:
   - Personal names (e.g., "Max Mustermann", "John Doe") with `[NAME_REDACTED]`
   - Depotnummer values (e.g., "55000000999") with `[ACCOUNT_REDACTED]`
...
From the extracted text of `20260130_KaufFondsZertifikate_55000000999_100000004.pdf`:
...
From the extracted text of `20251002_Fondsertragsausschuettung_55000000999_100000002.pdf`:
...
From the extracted text of `20251003_Fondsertragsausschuettung_55000000999_100000003.pdf`:
Follow same redaction process.
...
1. trade_sample_1_redacted.txt
   Source: 20250916_KaufFondsZertifikate_55000000999_100000001.pdf
   Type: TRADE
   PII Redacted: Names, account numbers, ISINs, amounts, dates

2. trade_sample_2_redacted.txt
   Source: 20260130_KaufFondsZertifikate_55000000999_100000004.pdf
   Type: TRADE
   PII Redacted: Names, account numbers, ISINs, amounts, dates

3. dividend_sample_1_redacted.txt
   Source: 20251002_Fondsertragsausschuettung_55000000999_100000002.pdf
   Type: DIVIDEND
   PII Redacted: Names, account numbers, ISINs, amounts, dates

4. dividend_sample_2_redacted.txt
   Source: 20251003_Fondsertragsausschuettung_55000000999_100000003.pdf
   Type: DIVIDEND
   PII Redacted: Names, account numbers, ISINs, amounts, dates
...
```bash
cd /Users/welworx/dev-private/flatex-pdf-cli
go run main.go sensitive_test_docs/20250916_KaufFondsZertifikate_55000000999_100000001.pdf
go run main.go sensitive_test_docs/20260130_KaufFondsZertifikate_55000000999_100000004.pdf
go run main.go sensitive_test_docs/20251002_Fondsertragsausschuettung_55000000999_100000002.pdf
go run main.go sensitive_test_docs/20251003_Fondsertragsausschuettung_55000000999_100000003.pdf
```
