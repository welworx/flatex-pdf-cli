...
func TestOutputWithMetadata(t *testing.T) {
	...
	if !contains(jsonStr, "55000000999") {
	...
	if rout.Metadata != nil && rout.Metadata.DepotNumber != "55000000999" {
		t.Errorf("DepotNumber mismatch: got %q, want %q", rout.Metadata.DepotNumber, "55000000999")
	}
